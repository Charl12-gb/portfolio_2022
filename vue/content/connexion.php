...
<form action="" method="POST" x-data="{ dirty: false }" class="pt-12">
  
  <input type="hidden" name="_token" value="YiEUgIcqRUMqeOKvshiO3Jf6wrae70V4bgoT0IbN">  <input type="hidden" name="remember" value="true" />
  <div class="relative">
  ...
  <div class="relative">
    ...
    <input x-ref="password" id="password" name="password" type="password" required class="text-gray-900 ring-gray-900 ring-opacity-5 placeholder-gray-400 appearance-none bg-white rounded-md block w-full px-3 py-2 border border-transparent shadow ring-1 sm:text-sm mb-6 focus:border-teal-500 focus:ring-teal-500 focus:outline-none" placeholder="Password" @input="dirty = true"  />
      </div>
